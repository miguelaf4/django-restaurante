...
class ContactForm(forms.Form):
    ...
    email = forms.EmailField(label="Email", required=True,widget=forms.EmailInput(attrs={'class': 'form-control','placeholder': 'Escribe tu correo'}), min_length=3, max_length=100)
